...
<html>
    {{#block 'head'}}
        <head>
            ...
            {{/block}}
            {{#block 'title'}}
                <title>{{translatePageTitle pageTitlePrefix pageTitle pageCategory}} &bullet; Sprinting Docs</title>
            {{/block}}
            {{#block 'css'}}
                ...
                <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.4.0/styles/github-gist.min.css">
                <script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.4.0/highlight.min.js"></script>
                <script src="scripts/prettify.js"></script>
                <script>hljs.initHighlightingOnLoad();hljs.initLineNumbersOnLoad();localStorage.tree = localStorage.tree || '{"open_nodes":["Sprinting"]}';</script>
